...
//!
//! (The audience here is potentially non-coders who just want to know what this pallet does, not
//! how it does it.)
//!
...
//! ### Design (optional)
//!
//! (Describe how you've reached those goals. This should describe the storage layout of your pallet
//! and what was your approach in designing it that way.)
//!
//! ### Terminology (optional)
//!
//! (Optionally, explain any non-obvious terminology here. You can link to it if you want to use the
//! terminology further up.) # License
//!
//! Apache-2.0
//!
//! # References
